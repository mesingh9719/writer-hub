        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    ...
                    @auth
                        <a href="{{ route('dashboard') }}" wire:navigate class="flex items-center bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 px-4 py-2 rounded-md" ><svg xmlns="http://www.w3.org/2000/svg" class="text-indigo-600 dark:text-indigo-400 mr-3 h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
